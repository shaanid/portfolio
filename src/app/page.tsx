      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className='min-h-screen'>
          ...
          <div className='text-5xl flex justify-center gap-16 py-3 text-gray-500'>
            <a href="https://twitter.com/shanid047"><AiFillTwitterCircle /></a>
            <a href="https://www.linkedin.com/in/mohamed-shanid-tom/"><AiFillLinkedin /></a>
            <a href="https://github.com/shanid07"><AiFillGithub /></a>
          </div>
